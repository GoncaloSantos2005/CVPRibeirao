...
namespace SistemaPDI.Infrastructure.Migrations
{
    ...
    [Migration("20260223102852_AdicionarTabelaUtilizadores")]
    partial class AdicionarTabelaUtilizadores
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaPDI.Domain.Entities.Utilizador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            CriadoEm = new DateTime(2026, 2, 23, 10, 28, 52, 292, DateTimeKind.Utc).AddTicks(9144),
                            Email = "admin@cvp.pt",
