...
namespace SistemaPDI.Infrastructure.Migrations
{
    ...
    [Migration("20260223104038_AtualizarHashAdmin")]
    partial class AtualizarHashAdmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaPDI.Domain.Entities.Utilizador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            CriadoEm = new DateTime(2026, 2, 23, 10, 40, 37, 741, DateTimeKind.Utc).AddTicks(8860),
                            Email = "admin@cvp.pt",
                            NomeCompleto = "Administrador Sistema",
                            PasswordHash = "$2a$11$KZx.vBGhH0FvM5R8f0Z9xOZ0Q3N8h7Y8B8J0Z9xOZ0Q3N8h7Y8B8J",
